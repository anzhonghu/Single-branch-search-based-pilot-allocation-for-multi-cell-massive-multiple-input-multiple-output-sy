...
set(h1,'PaperType','A4');
xx = axes('FontSize',16);
plot(K_s, rate_store(:,3),'b:o','LineWidth',2,'MarkerSize',10)
hold on
plot(K_s, rate_store(:,2),'m:x','LineWidth',2,'MarkerSize',10)
plot(K_s, rate_store(:,1),'k-^','LineWidth',2,'MarkerSize',10)
grid on
...
set(gca,'XTick',K_s)
xlabel('Number of the MSs','Fontsize',20,'Fontname','Times')
