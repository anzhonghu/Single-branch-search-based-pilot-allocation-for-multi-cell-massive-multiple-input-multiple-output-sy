...
% SNR_s = 0;%[0; 10; 20; 30; 40];
SNR_s = [0; 5; 10; 15; 20];%rho_up, rho_down, in dB
...
x_temp=zeros(K,3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
rate_store = zeros(length(SNR_s), 4);
rate_storett = zeros(length(SNR_s), 4);
...
set(h1,'PaperType','A4');
xx = axes('FontSize',16);
plot(SNR_s, rate_store(:,3),'b:o','LineWidth',2,'MarkerSize',10)
hold on
plot(SNR_s, rate_store(:,2),'m:x','LineWidth',2,'MarkerSize',10)
