...
for j_fz = 1 : L
    if l0 == j_fz%%%j
        for k_zl0 = 1 : K%%%%%k
            ...
            f_zl0(1, 1) = f_zl0(1, 1) + gamma(l0, k_zl0)^2 / (1+gamma(l0, k_zl0)) * finalsumkzl0;
        end
    else
        if 1 == j_fz
            X_final = Zl0_temp;
        ...
        for k_zl0 = 1 : K%%%%%%%%%%%%%%5k
            ...
            f_zl0(1, 1) = f_zl0(1, 1) + gamma(j_fz, k_zl0)^2 / (1+gamma(j_fz, k_zl0)) * finalsumkzl0;
        end
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for j_fz = 1 : L
    if l0 == j_fz%%%j
        for k_zl0 = 1 : K%%%%%k
            ...
            f_zl0(1, 1) = f_zl0(1, 1) + gamma_down(l0, k_zl0)^2 / (1+gamma_down(l0, k_zl0)) * finalsumkzl0;
        end
    else
        if 1 == j_fz
            X_final = Zl0_temp;
        ...
        for k_zl0 = 1 : K%%%%%%%%%%%%%%5k
            ...
            f_zl0(1, 1) = f_zl0(1, 1) + gamma_down(j_fz, k_zl0)^2 / (1+gamma_down(j_fz, k_zl0))  * finalsumkzl0;
        end
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
